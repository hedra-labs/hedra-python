...
[![PyPI version](<https://img.shields.io/pypi/v/hedra-python.svg?label=pypi%20(stable)>)](https://pypi.org/project/hedra-python/)
...
async def main() -> None:
    response = await client.generations(
        generated_video_inputs={"text_prompt": "text_prompt"},
        ai_model_id="d1dd37a3-e39a-4854-a298-6510289f9cf2",
        audio_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
        start_keyframe_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
...
```sh
# install from PyPI
pip install hedra-python[aiohttp]
```
...
import os
import asyncio
from hedra import DefaultAioHttpClient
from hedra import AsyncHedra


async def main() -> None:
    async with AsyncHedra(
        api_key=os.environ.get("HEDRA_API_KEY"),  # This is the default and can be omitted
...
print(response.generated_video_inputs)
```
...
client.with_options(max_retries=5).generations(
    generated_video_inputs={"text_prompt": "text_prompt"},
    ai_model_id="d1dd37a3-e39a-4854-a298-6510289f9cf2",
    audio_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
    start_keyframe_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
...
client.with_options(timeout=5.0).generations(
    generated_video_inputs={"text_prompt": "text_prompt"},
    ai_model_id="d1dd37a3-e39a-4854-a298-6510289f9cf2",
    audio_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
    start_keyframe_id="3c90c3cc-0d44-4b50-8888-8dd25736052a",
...
client = response.parse()  # get the object that `generations()` would have returned
print(client)
```
