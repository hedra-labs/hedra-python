...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_eyeline_id_relight</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputEyelineIdRelight, InputEyelineIdRelightSourceVideo_Url, InputEyelineIdRelightImagesItem_Url
from hedra.environment import HedraEnvironment
...
client.jobs.submit_eyeline_id_relight(
    input=InputEyelineIdRelight(
        prompt="prompt",
        source_video=InputEyelineIdRelightSourceVideo_Url(
            url="url",
        ),
        images=[
            InputEyelineIdRelightImagesItem_Url(
                url="url",
            )
        ],
    ),
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_eyeline_id_restyle</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputEyelineIdRestyle, InputEyelineIdRestyleSourceVideo_Url, InputEyelineIdRestyleImagesItem_Url
from hedra.environment import HedraEnvironment
...
client.jobs.submit_eyeline_id_restyle(
    input=InputEyelineIdRestyle(
        prompt="prompt",
        source_video=InputEyelineIdRestyleSourceVideo_Url(
            url="url",
        ),
        images=[
            InputEyelineIdRestyleImagesItem_Url(
                url="url",
            )
        ],
    ),
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_flux3video_upscaler_creative</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputFlux3VideoUpscalerCreative, InputFlux3VideoUpscalerCreativeSourceVideo_Url
from hedra.environment import HedraEnvironment
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_flux3video_upscaler_precise</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputFlux3VideoUpscalerPrecise, InputFlux3VideoUpscalerPreciseSourceVideo_Url
from hedra.environment import HedraEnvironment
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_gemini_omni_flash11</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_gpt_image25flare</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_gpt_image25sunburst</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_krea2</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_ltx25</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputLtx25
from hedra.environment import HedraEnvironment
...
```python
from hedra import Hedra, InputMinimaxH3MaxCameraControls, InputMinimaxH3MaxCameraControlsStartImage_Url, InputMinimaxH3MaxCameraControlsCameraTrajectoryItem
from hedra.environment import HedraEnvironment
...
client.jobs.submit_minimax_h3max_camera_controls(
    input=InputMinimaxH3MaxCameraControls(
        prompt="prompt",
        resolution="480p",
        duration_ms=1,
        start_image=InputMinimaxH3MaxCameraControlsStartImage_Url(
            url="url",
        ),
        camera_trajectory=[
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_minimax_h3max_turbo</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputMinimaxH3MaxTurbo
from hedra.environment import HedraEnvironment
...
client.jobs.submit_minimax_h3max_turbo(
...
<details><summary><code>client.jobs.<a href="src/hedra/jobs/client.py">submit_topaz_image_upscaler_transparency</a>(...) -> SubmitResponse</code></summary>
<dl>
<dd>
...
```python
from hedra import Hedra, InputTopazImageUpscalerTransparency, InputTopazImageUpscalerTransparencySourceImage_Url
from hedra.environment import HedraEnvironment
...
client.jobs.submit_topaz_image_upscaler_transparency(
    input=InputTopazImageUpscalerTransparency(
        source_image=InputTopazImageUpscalerTransparencySourceImage_Url(
            url="url",
        ),
    ),
)
...
<details><summary><code>client.billing.<a href="src/hedra/billing/client.py">list_llm_usage</a>(...) -> LlmUsageRecordListResponse</code></summary>
<dl>
<dd>
...
**cursor:** `typing.Optional[str]` — Opaque cursor from the previous page's `next_cursor`; omit for the first page. Each cursor records the filters it was issued under, so a walk must keep them fixed.
...
**start:** `typing.Optional[datetime.datetime]` — Only requests created at or after this instant (ISO-8601). Unlike `GET /v3/usage` there is no default window and no window cap.
...
**end:** `typing.Optional[datetime.datetime]` — Only requests created before this instant (ISO-8601, exclusive).
...
**model:** `typing.Optional[str]` — Only requests admitted for this model id.
...
**key_id:** `typing.Optional[str]` — Only requests made with this API key (its `key_id`, as listed by GET /v3/keys). An unknown key id yields an empty page.
...
## Chat
<details><summary><code>client.chat.<a href="src/hedra/chat/client.py">completions_create</a>() -> typing.Any</code></summary>
<dl>
<dd>
...
<details><summary><code>client.chat.<a href="src/hedra/chat/client.py">llms_list</a>() -> LlmModelList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.chat.<a href="src/hedra/chat/client.py">llms_get</a>(...) -> LlmModelObject</code></summary>
<dl>
<dd>
