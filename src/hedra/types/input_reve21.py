...
class InputReve21(UniversalBaseModel):
    """
    ...
    aspect_ratio: InputReve21AspectRatio = pydantic.Field()
    """
    Output aspect ratio.
    """

    output_format: typing.Optional[InputReve21OutputFormat] = pydantic.Field(default=None)
    """
    Output image format.
    """
