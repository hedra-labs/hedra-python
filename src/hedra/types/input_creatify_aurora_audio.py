...
InputCreatifyAuroraAudio = typing_extensions.Annotated[
    typing.Union[InputCreatifyAuroraAudio_Url, InputCreatifyAuroraAudio_Asset], pydantic.Field(discriminator="source")
]
