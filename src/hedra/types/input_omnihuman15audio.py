...
InputOmnihuman15Audio = typing_extensions.Annotated[
    typing.Union[InputOmnihuman15Audio_Url, InputOmnihuman15Audio_Asset], pydantic.Field(discriminator="source")
]
