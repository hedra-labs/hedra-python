...
InputVeedFabric10Audio = typing_extensions.Annotated[
    typing.Union[InputVeedFabric10Audio_Url, InputVeedFabric10Audio_Asset], pydantic.Field(discriminator="source")
]
