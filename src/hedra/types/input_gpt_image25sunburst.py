...
from .input_gpt_image25sunburst_images_item import InputGptImage25SunburstImagesItem
...
class InputGptImage25Sunburst(UniversalBaseModel):
    """
    ...
    aspect_ratio: InputGptImage25SunburstAspectRatio = pydantic.Field()
    """
    Output aspect ratio.
    """

    resolution: InputGptImage25SunburstResolution = pydantic.Field()
    """
    Output resolution.
    """

    output_format: typing.Optional[InputGptImage25SunburstOutputFormat] = pydantic.Field(default=None)
    """
    Output image format.
    """

    images: typing.Optional[typing.List[InputGptImage25SunburstImagesItem]] = pydantic.Field(default=None)
    """
    Images to edit or blend. 1 to 16 images, each at most 30 MB.
    """

    quality: typing.Optional[InputGptImage25SunburstQuality] = pydantic.Field(default=None)
    """
