...
class RawBillingClient:
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=TransactionListResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def list_llm_usage(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[LlmUsageRecordListResponse]:
        """
        Parameters
        ----------
        limit : typing.Optional[int]
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=LlmUsageRecordListResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawBillingClient:
    ...
    async def list_llm_usage(
        ...
        *,
        ...
        key_id: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[LlmUsageRecordListResponse]:
        """
        Parameters
        ----------
        limit : typing.Optional[int]
