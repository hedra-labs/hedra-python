...
from hedra.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
@patch("hedra.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("hedra.core.http_client.asyncio.sleep", new_callable=AsyncMock)
